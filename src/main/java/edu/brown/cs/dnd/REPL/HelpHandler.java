    ...
    public Result run(String[] args) throws InvalidInputException {
      ...
      switch (args[1]) {
        ...
        case "generate-encounter": {
          String s = "- generate-encounter <combinedLevels>: generates a " +
              "random "
              + "encounter for a party of combinedLevels levels (e.g. "
              + "generate-encounter 24, for 3 players of level 8)";
          return toResult(s);
        }
        case "dungeon":
